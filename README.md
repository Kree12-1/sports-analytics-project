...
##project overview
This project introduces a Badminton Performnace impact Dashboard for tournamnets organized by the Badminton World Federation(BWF). The idea goes beyond basic match results and develop support tool that evulates player performance.
